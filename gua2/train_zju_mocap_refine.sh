...
for TYPE in ${TYPES[@]}; do
    ...
    # python train.py -s $dataset --eval --exp_name zju_mocap_refine/${SEQUENCE}_seg --motion_offset_flag --smpl_type smpl --actor_gender neutral --iterations 1200 --port 7000
     python train.py -s $dataset --eval --exp_name zju_mocap_refine/my_377_${TYPE} --motion_offset_flag --smpl_type smpl --actor_gender neutral --iterations 1200 --port 7000
done