...
for TYPE in ${TYPES[@]}; do
    ...
    CUDA_VISIBLE_DEVICES=1 python train.py -s $dataset --eval --exp_name zju_mocap_refine/my_377_${TYPE} --motion_offset_flag --smpl_type smpl --actor_gender neutral --iterations 1200 --port 7007
done